...
public class UserGenerator implements Generate {
    ...
    public static final String PATH_NAMES = "src/ru/job4j/gc/leak2/files/names.txt";
    public static final String PATH_SURNAMES = "src/ru/job4j/gc/leak2/files/surnames.txt";
    public static final String PATH_PATRONS = "src/ru/job4j/gc/leak2/files/patr.txt";
